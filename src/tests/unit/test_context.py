...
def test_local_route_schemas_redact_every_secret_they_carry() -> None:
    ...
    schemas = (
        ...
        accounts_module.LocalRegistration(identifier=identifier, password=secret, display_name="User"),
        accounts_module.LocalInvitationRegistration(identifier=identifier, password=secret, invitation_token=secret),
        accounts_module.LocalToken(token=secret),
        accounts_module.LocalPasswordReset(token=secret, password=secret),
        accounts_module.LocalPasswordChange(current_password=secret, password=secret, compromise=True),
    )
