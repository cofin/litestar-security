"""Compatibility shim for websocket configuration.

All configuration definitions have been consolidated into litestar_security.websocket._transport.
"""
...
from litestar_security.websocket._transport import WebSocketCloseCodes, WebSocketSecurityConfig
