"""Compatibility shim for oidc service tokens.

All service token definitions have been consolidated into litestar_security.providers.oidc._provider.
"""
...
from litestar_security.providers.oidc._provider import ServiceTokenConfig
