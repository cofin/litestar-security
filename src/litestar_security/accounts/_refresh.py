...
from litestar_security.accounts._records import LocalAccountState, SecurityEvent
...
class RefreshTokenService(Generic[UserT]):
    ...
    async def issue(  # noqa: PLR0911 - preserve explicit sanitized outcomes
        ...
        *,
        ...
        if (
            not isinstance(account_value, LocalAccountState)  # pyright: ignore[reportUnnecessaryIsInstance] - defend runtime port boundary
