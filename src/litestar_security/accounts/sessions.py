"""Native session records, binding proofs, registry, and session authentication backend.
...
from litestar_security.accounts.models import SecurityEvent
...
if TYPE_CHECKING:
    ...
    from litestar_security.accounts.models import LocalAccountState
    ...
    async def authenticate(
        ...
        if now - record.last_seen_at >= self.binding.touch_interval:
            try:
                ...
                _LOGGER.error("Session last-seen update failed")
